...
exports.UsersModule = UsersModule = __decorate([
    (0, common_1.Module)({
        imports: [auth_module_1.AuthModule, axios_1.HttpModule, integration_module_1.IntegrationModule, cards_module_1.CardsModule, wallet_module_1.WalletModule, config_1.ConfigModule, (0, common_1.forwardRef)(() => wallet_module_1.WalletModule), typeorm_1.TypeOrmModule.forFeature([user_entity_1.User, document_entity_1.UserDocument, otp_info_entity_1.OtpInfo])],
        providers: [users_service_1.UsersService, config_2.ConfigService, updaload_file_service_1.UploadFileService, otp_flow_service_1.OtpFlowService, sms_client_service_1.SmsClientService, mail_service_1.MailService, otp_repository_1.OtpRepository],
